...
train_dataloader =dict(
    ...
    dataset=dict(
        ...
        ann_file = '/HOME/scz4239/run/mmsegmentation/data/Glomeruli-dataset/splits/train.txt')
)
...
val_dataloader =dict(
    ...
    dataset=dict(
        ...
        ann_file = '/HOME/scz4239/run/mmsegmentation/data/Glomeruli-dataset/splits/val.txt')
)
